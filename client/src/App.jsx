    ...
    <div className='w-screen h-screen bg-gray-100 flex justify-center items-center'>
      {
        ...
        <div className='rounded-md p-2 w-full md:w-[80vw] lg:w-[40vw] mx-auto'>
          <h1 className='text-center font-bold text-x1 my-2 uppercase'>talk-a-tive</h1>
          <div>
...
<button type='submit' className='px-3 py-2 bg-green-500 text-white rounded-md font-bold'>Send</button>
            </form>
        ...
        <div className='w-screen h-screen flex justify-center items-center gap-2'>
          <input type="text" value ={username} onChange={(e)=> setUserName(e.target.value)} className='text-center px-3 py-2 outline-none border-2 rounded-md'/>
          <button type="submit" className='bg-green-500 text-white px-3 py-2 rounded-md font-bold'
